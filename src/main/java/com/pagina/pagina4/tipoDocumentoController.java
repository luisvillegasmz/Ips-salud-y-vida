...
public class TipoDocumentoController {
    ...
    @PostMapping("/guardar")
    public String guardar(@Valid @ModelAttribute("tipoDocumento") TipoDocumento tipo,
        ...
        try {
            ...
            ra.addFlashAttribute("exito", "Tipo de documento guardado correctamente");
    ...
    public String cambiarEstado(@PathVariable Integer id, RedirectAttributes ra) {
        try {
    ...
    @PostMapping("/api")
    @ResponseBody
    public ResponseEntity<?> apiGuardar(@RequestBody TipoDocumento tipo) {
        try {
